...
function Cart({ cart = [], setCart, postCartData, handleCheckout, removeCartItem, handleQuantityChange }) {
          ...
          cart.map((item) => (
            <div className="cart_box" key={`${item.id}-${item.selectedOption.id}`}>
              <div className="cart_img">
                ...
                <button className='quantity-btn' onClick={() => handleQuantity(item, 1)}>+</button>
