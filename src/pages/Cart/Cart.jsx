...
//     const filteredCart = cart.filter((item) => !(item.id === id && item.options.id === optionId));
//     setCart(filteredCart);
//   };
...
//         ) : (
//           cart.map((item) => (
//             <div className="cart_box" key={`${item.id}-${item.options.id}`}>
//               <div className="cart_img">
//                 <img src={item.image_src} alt={item.vendor} />
//                 <p>{item.vendor}</p>
//                 <p>{item.name}</p>
//                 <p>Size: {item.options.value}</p>
//                 <button className='quantity-btn' onClick={() => handleChange(item, 1)}>+</button>
//                 <button className='quantity-btn'>{item.amount}</button>
//                 <button className='quantity-btn' onClick={() => handleChange(item, -1)}>-</button>
//               </div>
//               <div>
//                 <span>${item.price}</span>
//                 <button className='remove-btn' onClick={() => handleRemove(item.id, item.options.id)}>Remove</button>
//               </div>
//             </div>
//           ))
//         )}
