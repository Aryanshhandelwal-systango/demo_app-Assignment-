...
//  const [selectedSize, setSelectedSize] = useState({id:null, value: null});

//   const detailPage = (product) => {
//     dispatch(setDetail(product));
//   };
//   const handleSizeClick = (option) => {
//     setSelectedSize({ id: option.id, value: option.value });
//   };
...
//                           <button key={option.id} className="size_buttons" onClick={() => handleSizeClick(option)}>
//                             {option.value}
//                           </button>
//                         ))}
//                   </h4>
...
//                     </span>
//                   </p>
//                   <button onClick = {() => {handleClick({...detail, selectedSize, amount: 1})}}>Add to Cart</button>
//                 </div>
//               </div>
//             </div>
//           </div>
...
//                           <button key={option.id} className="product_size_buttons" onClick={() => handleSizeClick(option)}>
//                             {option.value}
//                           </button>
//                         ))}
//                       </div>
