                ...
                <div className="wishlist-container">
                  <div className="wishlist-icon" onClick={() => handleWishlistClick(detail)}>
                    <img
                      src={heartIcon}
                      alt="Wishlist"
                      className={Array.isArray(wishlist) && wishlist.find(item => item.id === detail.id) ? 'wishlist-icon red' : 'wishlist-icon'}
                    />
              ...
              <div className="wishlist-container">
                <div className="wishlist-icon" onClick={() => handleWishlistClick(shirt)}>
                  <img
                    src={heartIcon}
                    alt="Wishlist"
                    className={Array.isArray(wishlist) && wishlist.find(item => item.id === shirt.id) ? 'wishlist-icon red' : 'wishlist-icon'}
                  />
